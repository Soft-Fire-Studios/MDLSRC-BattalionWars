function CUTSCENE_SKIP(owner)
  ...
  if IsNetworkPlayer(constant.PLAYER_ONE) then
    ...
    StoreSummaryMessage(0, 7, constant.ARMY_SOLAR, SpriteID.CO_SE_Leiqo_Helmet_Happy)
  ...
  if IsNetworkPlayer(constant.PLAYER_TWO) then
    ...
    StoreSummaryMessage(1, 8, constant.ARMY_UNDERWORLD, SpriteID.CO_L_Ferrok_Happy)
