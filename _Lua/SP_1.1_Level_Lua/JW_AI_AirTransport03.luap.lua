function JW_AI_AirTransport03(owner)
  repeat
    EndFrame()
  ...
  while true do
    if GetMovementState(owner) == constant.MOVEMENT_STATE_ON_GROUND then
      ...
      LandAirUnit(owner, GetObjectXPosition(Waypoint.AI_AirTransport03), GetObjectZPosition(Waypoint.AI_AirTransport03), constant.ORDER_FORCED)
      WaitFor(3)
    end
    EndFrame()
  end
