function JW_AI_AirTransport04(owner)
  while true do
    if GetMovementState(owner) == constant.MOVEMENT_STATE_ON_GROUND then
      break
    else
      LandAirUnit(owner, GetObjectXPosition(Waypoint.AI_AirTransport04), GetObjectZPosition(Waypoint.AI_AirTransport04), constant.ORDER_FORCED)
      WaitFor(3)
    end
    EndFrame()
  end
