function XV_ATP04(owner)
  local self = Air_Vehicle.XV_ATP04
  while InStartCutscene do
    EndFrame()
  end
  SetObjectiveData(Objective_Marker.XV_ATP04, constant.OBJECTIVE_MARKER_DATA_VISIBLE, 1)
  while true do
  ...
  LandAirUnit(self, 415, 810, constant.ORDER_FORCED)
  ...
  XV_ATP04Dead = true
  SetObjectiveData(Objective_Marker.XV_ATP04, constant.OBJECTIVE_MARKER_DATA_VISIBLE, 0)
end
